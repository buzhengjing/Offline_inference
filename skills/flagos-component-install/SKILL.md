...
FlagTree 状态：
```bash
docker exec $CONTAINER bash -c "PATH=/opt/conda/bin:\$PATH python3 /Offline_inference_workspace/scripts/install_component.py --component flagtree --action verify --json"
```
